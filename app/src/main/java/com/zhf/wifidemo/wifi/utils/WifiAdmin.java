...
public class WifiAdmin {
     ...
     * 添加指定网络
     **/
    public void addNetworkAndConnect(WifiConfiguration paramWifiConfiguration) {
...
//    		}
    ...
    public boolean Wificonnect(String wifiName, String wifiPwd) {
        // 连接到外网
        ...
        if (tempConfig == null) {
            ...
            mWifiConfiguration = createWifiInfo(SSID, password, 3, "wt");
            addNetworkAndConnect(mWifiConfiguration);
            return connectNetwork(mWifiConfiguration);
        } else {
